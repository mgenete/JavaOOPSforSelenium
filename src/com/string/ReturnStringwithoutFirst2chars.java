...
public class ReturnStringwithoutFirst2chars {
	...
	public static void main(String[] args) {
		System.out.println(deFront("abeba"));
		System.out.println(deFront("cbeba"));
		System.out.println(deFront("eeba"));
		System.out.println(deFront("r"));
